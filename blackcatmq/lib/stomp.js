...
var DELIMETER = (module.exports.DELIMETER =
  DELIMETERS[require("os").platform()] || DELIMETERS.linux);
...
module.exports.ServerFrame = {
  CONNECTED: function (session, identifier) {
    return Frame({
      command: "CONNECTED",
      header: { session: session, identifier: identifier },
    });
  },
  ...
  RECEIPT: function (receipt) {
    return Frame({ command: "RECEIPT", header: { "receipt-id": receipt } });
  },
